/server.js: serverýn sürekli çalýþan ana aktivitesi

/constants.js: Bazý yerlerde kullanýlan constantlar

/dbConnection.js: Veritabaný unsurlarýnýn export edildiði dosya

/fakeMessengerMotion.html:
Normalde kuryenin cep telefonundan serverýmýza soketler aracýlýðýyla gelen konum verilerini sipariþ bekleyen müþteriye yine serverýmýz tarafýndan göndermekteyiz ve google maps üzerinde konumu sürekli güncellemekteyiz. Pratikte hareketli bir kurye kullanamayacaðýmýz için bu html dosyasýndan serverýmýza 2 saniyede bir, daha önceden belirlenen meridyen koordinatlarýný alarak týpký bir kuryeyi simüle ediyoruz.

Android uygulamamýzda sipariþ tamamlandýktan sonra açýlan harita kapatýlmadan bu html dosyasý çalýþtýrýldýðýnda, açýlan o haritada kuryenin hareketinin simüle edildiðini görebilirsiniz.

/methods/
|_ tools.js: Kýsa metotlarýn export edildiði dosya.
|_ userMethods.js: Kaydolma ve giriþ metotlarý
|_ orderMethods.js: sipariþ için ürün ekleme, çýkarma, sepetteki
|  			    ürünleri görme, sipariþi tamamlama metotlarý
|
|_ listingMethods.js: kategorileri ve herhangi bir kategorinin
|    				 ürünlerini listeleyen metotlar
|
|_ messengerMethods.js: Tamamlanamadý
...
| mpassword: parolanýn geri dönüþtürelemez þekilde özelleþmiþ
| halidir;
| sessionCode: üye giriþi sýrasýnda üyeye ve zamana özel
| üretilmiþ benzersiz koddur;
| addressX ve addressY sipariþ verilmesi durumunda kiþinin
| geometrik konumunudur;
| now: üyenin sisteme kaydolduðu zamanýn saniye cinsinden
| deðeridir.
| --------------------------------------------------------
| messengers
...
| locationX ve locationY: kuryenin soketlerle anlýk olarak 
| alýnan konumu;
| nearStock: kuryenin daðýtým yaptýðý depoda olup olmadýðý
| bilgisidir, diðer bir deyiþle
...
|
| Açýklama: üyelerin sipariþ vermek üzereykenki ürünlerin
| tablosu
...
|
| Açýklama: Ücreti ödenmiþ ve daðýtýmý bekleyen sipariþlerin
| tablosu;
...
| addressX ve addressY: teslimat yapýlacak yerin geometrik 
| konumlarý;
| messengerNo: status 1 veya 2 ise ilgili kuryenin
| tablosundaki | idsi;
| status0time, status1time ve status2time: sipariþin ödemeden
| itibaren bulunduðu durumlarýn saniye cinsinden tarihi
| ----------------------------------------------------------
| stocks
